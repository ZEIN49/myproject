...
class CustomerTestCase(TestCase):
    def setUp(self):
        Customer.objects.create(username='vivek',email='vray6640@gmail.com',phone_no='8794173921')
        Customer.objects.create(username='vikas',email='vikas@gmail.com',phone_no='9090909090')
